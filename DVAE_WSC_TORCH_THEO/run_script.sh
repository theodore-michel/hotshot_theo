...
# code execution
srun python -u run_train_model_torch.py --db_name ../../DATABASES/run_db_test  --train_nsamp 25600  --val_nsamp 5120 --test_nsamp 2560 --batch_size 512 --lr 0.001 --n_epochs 3 --log_interval 100 --ncomp 1 --skip_co '111' --check_interval 25 --model_outname $outname --platform JZ --test_mode BEST
